            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" id="form1" runat="server">
                    <span class="login100-form-title p-b-49">
                        <span style="color:mediumvioletred">CanBookGram</span> <span style="color:cornflowerblue">Login</span>
                    </span>
                    ...
                    <div class="container-login100-form-btn">
                        <div class="wrap-login100-form-btn">
                            ...
                            <asp:Button ID="btnLogin" runat="server" Text="Login" CssClass="login100-form-btn" ValidationGroup="Login" OnClick="btnLogin_Click" />
                        </div>
                    </div>
                    <br />
                     <center><asp:HyperLink ID="hypRegister" NavigateUrl="~/Register.aspx" runat="server" ForeColor="#cc00cc">Register Now!</asp:HyperLink></center>
                    <br />
                     <asp:Label ID="lblMessage" runat="server" Font-Bold="True" ForeColor="Red" Visible="False"></asp:Label>
                    <br />
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtEmail" ErrorMessage="Please enter email" ForeColor="Red" ValidationGroup="Login"></asp:RequiredFieldValidator>
                    <br />
                     <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtPassword" ErrorMessage="Please enter password" ForeColor="Red" ValidationGroup="Login"></asp:RequiredFieldValidator>
                </form>
            </div>
        </div>
    </div>
