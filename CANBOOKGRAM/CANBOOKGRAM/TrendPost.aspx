<%@ Page Title="" Language="C#" MasterPageFile="~/UserMasterPage.master" AutoEventWireup="true" CodeFile="TrendPost.aspx.cs" Inherits="TrendPost" %>
                                ...
                                <div class="row">
                                    <div class="col-md-offset-1 col-md-8 col-md-offset-1">
                                        <div class="form-horizontal">
                                            <div class="box-body">
                                                <asp:DataList ID="dlUserPicture" Width="100%" runat="server">
                                                    <ItemTemplate>
